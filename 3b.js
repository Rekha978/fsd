...
// This is a simple React component that returns JSX (which looks like HTML) function App() { 
return ( 
<div> 
<h1>Hello, React!</h1> 
...
JavaScript 
import React from 'react'; 
import ReactDOM from 'react-dom/client'; // Import the new client for React 18 import App from './App'; // Import our component 
